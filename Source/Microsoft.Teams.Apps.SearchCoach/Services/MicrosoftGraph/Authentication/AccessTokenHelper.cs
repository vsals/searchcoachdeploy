...
namespace Microsoft.Teams.Apps.SearchCoach.Services.MicrosoftGraph.Authentication
{
    using System;
    ...
    public class AccessTokenHelper : ITokenHelper
    {
        ...
        public async Task<string> GetAccessTokenAsync(string userObjectId, string authorizationHeader)
        {
            ...
            try
            {
                ...
                var account = await this.confidentialClientApp.GetAccountAsync($"{userObjectId}.{this.azureAdOptions.Value.TenantId}");
