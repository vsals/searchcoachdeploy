...
namespace Microsoft.Teams.Apps.SearchCoach.Bot
{
    ...
    {
        /// <summary>
        /// Represents a set of key/value application configuration properties for Azure Active Directory.
        /// </summary>
        ...
        /// </summary>
        /// <param name="options"> A set of key/value configuration properties for Azure Active Directory.</param>
        /// <param name="logger">Logger implementation to send logs to the logger service.</param>
        /// <param name="localizer">The current cultures' string localizer.</param>
        public ActivityMiddleware(IOptions<AzureActiveDirectorySettings> options, ILogger<ActivityMiddleware> logger, IStringLocalizer<Strings> localizer)
        {
